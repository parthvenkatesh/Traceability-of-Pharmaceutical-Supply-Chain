          ...
          .call({ from: window.accounts[0] }, function(error, result) {
            if (error) {
              ...
              if (result == "0x0000000000000000000000000000000000000000") {
                ...
                window.co.methods
                  .addOwnership(0, item)
                  .send({ from: window.accounts[0], gas: 1000000 }, function(
                    error,
                    result
                  ) {
                    if (error) {
...
function getActivePart(parent) {
  ...
  for (var i = 0; i < item_list.length; i++) {
    if (
      item_list[i].parentElement.id == parent &&
...
async function init_web3() {
  ...
  window.pm.options.address = "0x71938b27B8c2B22895F9ef5129f2233d3430D41e";
  window.co = new web3.eth.Contract([
    ...
    },
    {
      ...
      type: "event",
      signature:
        "0x6a67eae68bb9deea9cbb16299fce22702092dc03cbcfd6a7babc7ac0036c7d4b"
    },
    {
      anonymous: false,
      inputs: [
      ...
      type: "event",
      signature:
        "0xe2d5b74efaa0dc370d71f08be6bc6c865613194b7345262a998fb5232622c0b2"
    },
    {
      constant: false,
      inputs: [
  ...
  window.co.options.address = "0x680AF5d55fcD699EDe4314818d25D45d1096E028";
}
...
function dealerPartListManager() {
  ...
  if (this.classList.contains("active")) {
    getOwnerHistoryFromEvents("TransferPartOwnership", this.textContent).then(
      owners => {
        console.log("bbb");
        console.log(owners);
